...
void AirBird_eq()
{
	...
	static float fD = powf(2.0f, 2.0f / 12.0f);
	...
	static float fB = powf(2.0f, -1.0f / 12.0f);
	...
	static float fCS = powf(2.0f, 1.0f / 12.0f);
	...
	static float fE = powf(2.0f, 4.0f / 12.0f);
