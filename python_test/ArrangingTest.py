...
arrangement=ScoreDraftArranging.Arrangement()
trackId1=arrangement.newInstrumentTrack("piano1", ScoreDraft.Piano())
trackId2=arrangement.newInstrumentTrack("piano2", ScoreDraft.Piano())
arrangement.addAction(ScoreDraftArranging.SetTempo(120))
arrangement.addAction(ScoreDraftArranging.SetReferenceFrequency(264.0 *1.25))
arrangement.addAction(ScoreDraftArranging.Perform(trackId1, seq1))
arrangement.addAction(ScoreDraftArranging.Perform(trackId2, seq2))

doc=ScoreDraftArranging.Document()
arrangement.runActions(doc)
